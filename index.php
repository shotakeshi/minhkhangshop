    ...
    <div class="slider-area layout1 slider-overlay-dark">
        <div class="bend niceties preview-1">
            <div id="ensign-nivoslider-3" class="slides">
                <img src="img/slider/1.png" alt="Minh Khang Gift | Trao gửi giá trị – Gói trọn yêu thương" title="#slider-direction-1" />
                <img src="img/slider/3.png" alt="Minh Khang Gift | Trao gửi giá trị – Gói trọn yêu thương" title="#slider-direction-2" />
                <img src="img/slider/4.png" alt="Minh Khang Gift | Trao gửi giá trị – Gói trọn yêu thương" title="#slider-direction-3" />
            </div>
        </div>
    </div>
